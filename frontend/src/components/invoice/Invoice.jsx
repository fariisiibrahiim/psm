...
const Invoice = () => {
  ...
  const handleDownload = () => {
    ...
    html2canvas(input).then((canvas) => {
      ...
      pdf.save(`immerstore_invoice_${order?._id}.pdf`);
    });
  };
        ...
        <div id="order_invoice" className="p-3 border border-secondary">
          <header className="clearfix">
            ...
            <div id="company" className="clearfix">
              ...
              <div>(60) 11-2400-3797</div>
              <div>
                <a href="mailto:info@immerstore.com">info@immerstore.com</a>
              </div>
            </div>
            <div id="project">
              <div>
            ...
            <table className="mt-5">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="total">RM{order?.taxAmount}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="total">RM{order?.shippingAmount}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="grand total">RM{order?.totalAmount}</td>
                </tr>
              </tbody>
            </table>
            <div id="notices">
